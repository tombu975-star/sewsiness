...
export function AccountCard() {
  ...
  async function handleSignOut() {
    ...
    // Cache so no stale authenticated page can flash back in. Lands on
    // the public landing page rather than /login — the landing page is
    // the default destination for anyone without a session, and still
    // offers a "Log in" button for a quick way back in.
