...
export const SIDEBAR: NavItem[] = [
  ...
  { label: "My Payments", icon: "\u25C9", href: "/freelancer-payments", roles: ["freelancer"], featureKey: "freelancers" },
  {
    ...
    children: [
      ...
      { label: "Skills Matrix", href: "/skills-matrix" },
  ...
  { label: "Training Sessions", icon: "\u25CE", href: "/training-sessions", roles: ["apprentice"], featureKey: "apprentices" },
  { label: "My Tasks", icon: "\u25A4", href: "/training-plans", roles: ["apprentice"], featureKey: "apprentices" },
  { label: "My Skills", icon: "\u2698", href: "/skills-matrix", roles: ["apprentice"], featureKey: "apprentices" },
  { label: "My Quizzes", icon: "\u2713", href: "/quizzes", roles: ["apprentice"], featureKey: "apprentices" },
...
export const MORE_MENU: MoreMenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Training Sessions", description: "Scheduled classes and attendance", icon: "\u25CE", href: "/training-sessions", roles: ["owner", "manager", "trainer", "apprentice"], featureKey: "apprentices" },
      { label: "Skills Matrix", description: "Competency levels per apprentice", icon: "\u2698", href: "/skills-matrix", roles: ["owner", "manager", "trainer", "apprentice"], featureKey: "apprentices" },
      { label: "Quizzes", description: "Auto-scored assessments", icon: "\u2713", href: "/quizzes", roles: ["owner", "manager", "trainer", "apprentice"], featureKey: "apprentices" },
      { label: "Training Compliance", description: "Certificate expiry and completion rates", icon: "\u25A8", href: "/training-compliance", roles: ["owner", "manager", "trainer"], featureKey: "apprentices" },
