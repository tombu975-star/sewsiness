...
// in production (a Vercel project environment variable) to your real
// deployed URL — without it, invite links fall back to localhost, which
...
// `${SITE_URL}/accept-invite` (an entry like `https://your-app.vercel.app/**`
