const TONES: Record<string, { cls: string; dot: string }> = {
  ...
  Confirmed: { cls: "bg-info-soft text-info", dot: "var(--info)" },
  "In Progress": { cls: "bg-info-soft text-info", dot: "var(--info)" },
  "In Production": { cls: "bg-info-soft text-info", dot: "var(--info)" },
  Ready: { cls: "bg-success-soft text-success", dot: "var(--success)" },
  Delivered: { cls: "bg-success-soft text-success", dot: "var(--success)" },
